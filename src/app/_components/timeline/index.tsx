export default () => {
  return (
    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical pr-5 pl-5">
      <li>
        ...
        <div className={"timeline-start mb-10 max-w-2xl text-left md:text-end"}>
          <time className="font-mono italic">1984</time>
          <div className="font-black text-lg">First Macintosh computer</div>
      ...
      <li>
        ...
        <div className="timeline-end max-w-2xl text-left md:mb-10">
          <time className="font-mono italic">1998</time>
          <div className="font-black text-lg">iMac</div>
      ...
      <li>
        ...
        <div className={"timeline-start mb-10 max-w-2xl text-left md:text-end"}>
          ...
          <div className="font-black text-lg">iPod</div>
      ...
      <li>
        ...
        <div className="timeline-end max-w-2xl text-left md:mb-10">
          ...
          <div className="font-black text-lg">iPhone</div>
      ...
      <li>
        ...
        <div className={"timeline-start mb-10 max-w-2xl text-left md:text-end"}>
          ...
          <div className="font-black text-lg">Apple Watch</div>
